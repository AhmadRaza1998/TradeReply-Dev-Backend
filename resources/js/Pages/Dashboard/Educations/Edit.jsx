...
export default function Edit({ education }) {
  ...
  const { data, setData, put, errors, isValidForm, handleChange } = useForms({
    fields: {
      title: get(education, "title", ""),
      content: get(education, "content", ""),
      tags: get(education, "tags", []),
      feature_image: "",
    },
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      if (!isValid) return;
      put(`/dashboard/education-manager/${get(education, "id", "")}`);
    } catch (error) {
      handleError(error);
    }
  };
      ...
      <form onSubmit={submit}>
        ...
        <div>
          <div className="mb-4 d-flex ">
            <img
              id="selectedImage"
              src={preview || get(education, "feature_image") || placeHolderImg}
